...
public class PickupWasteAction extends SimplePropertyObject implements ISpaceAction
{
	...
	{	
		...
		assert so.getProperty("accident") == null: so;
		
		Collection wastes = grid.getSpaceObjectsByGridPosition((IVector2)so.getProperty(Grid2D.PROPERTY_POSITION), "accident");
		System.out.println("ACIDENTE "+wastes.size());
